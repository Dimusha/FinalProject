...
public class updateshouldertaps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updateshouldertaps);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref = FirebaseDatabase.getInstance().getReference().child("shouldertaps");

...
public class UpdateDoummbleCurl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_doummble_curl);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref = FirebaseDatabase.getInstance().getReference().child("DoumbleCurl");

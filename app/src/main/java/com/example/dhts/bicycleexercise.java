...
public class bicycleexercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bicycleexercise);

        upplank = findViewById(R.id.updatebicycle);
        delbut = findViewById(R.id.deletebicycle);

        e1 = findViewById(R.id.addingbicycle);
        ...
        e1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i3  = new Intent(getApplicationContext(),addindbicycle.class);
                startActivity(i3);
        ...
        upplank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i4 = new Intent(getApplicationContext(),updatebicycle.class);
        ...
        delbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("bicycleexe");
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Additional info")){
                            ref =  FirebaseDatabase.getInstance().getReference().child("bicycleexe").child("Additional info");
                            ref.removeValue();

...
public class AddDummbellLateral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dummbell_lateral);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("DoumbleLateral");
                ...
                Intent i3  = new Intent(getApplicationContext(),DoumbleLateralView.class);

...
public class DummbellLateral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dummbell_lateral);

        btn = findViewById(R.id.button10);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),AddDummbellLateral.class);
                startActivity(i);
            }
        });
        ...
        updatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i3 = new Intent(getApplicationContext(),UpdateDoumblLateral.class);
        ...
        deletebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(i);
                DatabaseReference db1 = FirebaseDatabase.getInstance().getReference().child("DoumbleLateral");
                db1.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("item1")){
                            ref = FirebaseDatabase.getInstance().getReference().child("DoumbleLateral").child("item1");
                            ref.removeValue();

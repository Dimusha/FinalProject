...
public class AddDoumbleSqaut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_doumble_sqaut);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("DoumbleSquat");
                ...
                Intent i3  = new Intent(getApplicationContext(),DumSquat.class);

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i3 = new Intent(getApplicationContext(),UpdateOneArmRow.class);
        ...
        deletebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(i);
                DatabaseReference db1 = FirebaseDatabase.getInstance().getReference().child("OneArmRow");
                db1.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("item1")){
                            ref = FirebaseDatabase.getInstance().getReference().child("OneArmRow").child("item1");
                            ref.removeValue();

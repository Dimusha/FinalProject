...
public class AddDummbellFly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dummbell_fly);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("DoumbleFlys");
                ...
                Intent i3  = new Intent(getApplicationContext(),DummbellFlyViewPage.class);

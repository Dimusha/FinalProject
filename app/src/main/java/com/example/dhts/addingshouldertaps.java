...
public class addingshouldertaps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addingshouldertaps);
        add = new Adding();
        ...
        addingbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("shouldertaps");
                ...
                Intent i3  = new Intent(getApplicationContext(),shouldertaps.class);

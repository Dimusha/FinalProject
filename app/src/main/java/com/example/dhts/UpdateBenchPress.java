...
public class UpdateBenchPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_bench_press);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref = FirebaseDatabase.getInstance().getReference().child("DoumbleBenchPress");

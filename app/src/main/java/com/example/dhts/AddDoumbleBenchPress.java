...
public class AddDoumbleBenchPress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_doumble_bench_press);
        ...
        db= FirebaseDatabase.getInstance().getReference().child("DoumbleBenchPress");

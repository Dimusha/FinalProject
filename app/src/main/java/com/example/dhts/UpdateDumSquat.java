...
public class UpdateDumSquat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_dum_squat);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref = FirebaseDatabase.getInstance().getReference().child("DoumbleSquat");

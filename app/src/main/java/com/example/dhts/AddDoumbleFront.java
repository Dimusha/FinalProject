...
public class AddDoumbleFront extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_doumble_front);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("DummbellFrontRaise");
                ...
                Intent i3  = new Intent(getApplicationContext(),FrontRaisesViewPage.class);

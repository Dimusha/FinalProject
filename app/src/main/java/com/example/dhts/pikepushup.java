...
public class pikepushup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pikepushup);

        upplank = findViewById(R.id.updatepike);
        delbut = findViewById(R.id.deletepike);

        e1 = findViewById(R.id.addingpikepushup);
        ...
        e1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i3  = new Intent(getApplicationContext(),addpikepushupi.class);
                startActivity(i3);
        ...
        upplank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i4 = new Intent(getApplicationContext(),updatepikepushup.class);
        ...
        delbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("pikepushup");
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Additional info")){
                            ref =  FirebaseDatabase.getInstance().getReference().child("pikepushup").child("Additional info");
                            ref.removeValue();

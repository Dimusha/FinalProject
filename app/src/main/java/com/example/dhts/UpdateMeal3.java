...
public class UpdateMeal3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_meal3);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref.child("Plan3").updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
                    @Override

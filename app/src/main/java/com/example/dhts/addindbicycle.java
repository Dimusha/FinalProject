...
public class addindbicycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addindbicycle);
        ...
        addingbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("bicycleexe");
                ...
                Intent i3  = new Intent(getApplicationContext(),bicycleexercise.class);

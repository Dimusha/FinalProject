...
public class UpdateOneArmRow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_one_arm_row);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref = FirebaseDatabase.getInstance().getReference().child("OneArmRow");

                HashMap hashMap = new HashMap();

                hashMap.put("additional1", equipment);
                hashMap.put("additional2", stepp1);
                hashMap.put("additional2", stepp2);

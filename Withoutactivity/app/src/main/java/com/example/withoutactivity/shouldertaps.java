...
public class shouldertaps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shouldertaps);

        upplank = findViewById(R.id.updateshoultaps);
        delbut = findViewById(R.id.deleteshoultaps);

        e1 = findViewById(R.id.addingshoultaps);
        ...
        e1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i3  = new Intent(getApplicationContext(),addingshouldertaps.class);
                startActivity(i3);
        ...
        upplank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i4 = new Intent(getApplicationContext(),updateshouldertaps.class);
        ...
        delbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("shouldertaps");
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Additional info")){
                            ref =  FirebaseDatabase.getInstance().getReference().child("shouldertaps").child("Additional info");
                            ref.removeValue();

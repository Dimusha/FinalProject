...
public class addingcrunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addingcrunch);
        add = new Adding();
        ...
        addingbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("crunches");
                ...
                Intent i3  = new Intent(getApplicationContext(),crunches.class);

...
public class addingflutterkicks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addingflutterkicks);
        ...
        addingbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("flutterkicks");
                ...
                Intent i3  = new Intent(getApplicationContext(),flutterkicks.class);

...
public class addingwallpush extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addingwallpush);
        ...
        addingbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db= FirebaseDatabase.getInstance().getReference().child("wallpushups");
                ...
                Intent i3  = new Intent(getApplicationContext(),wallpush.class);

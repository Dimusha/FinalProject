...
public class flutterkicks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upplank = findViewById(R.id.updateflutter);
        delbut = findViewById(R.id.deleteflutter);

        e1 = findViewById(R.id.addingflutter);
        ...
        e1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i3  = new Intent(getApplicationContext(),addingflutterkicks.class);
                startActivity(i3);
        ...
        upplank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i4 = new Intent(getApplicationContext(),updateflutterkicks.class);
        ...
        delbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("flutterkicks");
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Additional info")){
                            ref =  FirebaseDatabase.getInstance().getReference().child("flutterkicks").child("Additional info");
                            ref.removeValue();

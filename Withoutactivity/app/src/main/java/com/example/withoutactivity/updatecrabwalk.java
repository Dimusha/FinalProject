...
public class updatecrabwalk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatecrabwalk);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref = FirebaseDatabase.getInstance().getReference().child("crabwalk");

...
public class crunches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upplank = findViewById(R.id.updatecrunch);
        delbut = findViewById(R.id.deletecrunch);

        e1 = findViewById(R.id.addingcrunch);
        ...
        e1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i3  = new Intent(getApplicationContext(),addingcrunch.class);
                startActivity(i3);
        ...
        upplank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i4 = new Intent(getApplicationContext(),updatecrunches.class);
        ...
        delbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("crunches");
                db.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("Additional info")){
                            ref =  FirebaseDatabase.getInstance().getReference().child("crunches").child("Additional info");
                            ref.removeValue();
